...
public class ProductsServiceIntegrationTest {
	...
	@Test
	void testCreateProduct_withGivenValidProductDetails_successfullSendsKafkaMessage() 
		throws Exception{
		// ARRANGE
		...
		// ACT
		productService.createProduct(createProductRestModel); // this method will send kafka message
